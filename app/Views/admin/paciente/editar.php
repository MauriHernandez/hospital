        ...
        <div class="row justify-content-center">
            ...
            <h1 align="center">Editar Paciente</h1>
                <div id="login-container" class="row justify-content-center">
                    <div class="col-md-6">
                        <form action="<?= base_url('/admin/paciente/editar/update'); ?>" method="POST">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-container">
                                ...
                                <div class="mb-3">
                                    <label for="genero" class="form-label">Sexo <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="sangre" style="color: #fff">Tipo de sangre <span
                                            class="text-danger"></label>
                                    <select name="sangre" id="sangre" class="form-control" required>
                                        <option value="<?= $paciente->sangre ?>" selected> <?= $paciente->sangre ?>
                                        </option>
                                ...
                                <div class="mab-3">
                                    <label for="numeroAsociacion" class="form-label">Número de Asociación <span
                                            class="text-danger">*</label>
                                    <input type="text" class="form-control" name="numeroAsociacion"
                                        id="numeroAsociacion" placeholder="Formato:XX-XXXXXXX" pattern="[0-9]{-}"
                                        max_lengh="10" required value="<?= $paciente->numeroAsociacion ?>">
