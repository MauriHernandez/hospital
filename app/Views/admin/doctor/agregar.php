...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-eLAPt5p2cqF5LTHKR2AxR9g3PO6cXdK6fj6c6rUJCC8CqGKOmKl3otcvlB6aXvpp" crossorigin="anonymous">
...
<div class="container">
    ...
    <h1 align="center">Agregar Doctor</h1>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form action="<?= base_url('/admin/doctor/agregarUsuario'); ?>" method="POST">
                <?= csrf_field() ?>
                <div class="form-container">
                    ...
                    <div class="mab-3">
                        <label for="especialidad" class="form-label">Especialidad <span class="text-danger">*</label>
                    ...
                    <div class="mab-3">
                        <label for="turno" class="form-label">Turno <span class="text-danger">*</label>
            ...
            <div class="form-container">
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="municipio" id="municipio"
                        placeholder="Formato: Teziutlán" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="50"
                        min_length="2">
                </div>

                <div class="mab-3">
                    <label for="colonia" class="form-label">Colonia <span class="text-danger">*</label>
                    <input type="text" class="form-control" name="colonia" id="colonia" placeholder="Formato: Xoloco"
                ...
                <div class="mab-3">
                    <label for="numeroExterior" class="form-label">Número exterior <span class="text-danger">*</label>
                ...
                <div class="mab-3">
                    <label for="numeroInterior" class="form-label">Número interior <span class="text-danger">*</label>
                    <input type="text" class="form-control" name="numeroInterior" id="numeroInterior" pattern="[0-9]+"
                        max_length="11">
                </div>

                <div class="mab-3">
                    <label for="codigoPostal" class="form-label">Código Postal <span class="text-danger">*</< /label>
